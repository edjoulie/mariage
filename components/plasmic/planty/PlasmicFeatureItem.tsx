...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: mO2Fghscjgep/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__tHaOu)}>
        <div className={classNames(projectcss.all, sty.freeBox__zeQtI)} />

        <div className={classNames(projectcss.all, sty.freeBox__wnYoi)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__qWNbj)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__buGzL)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__wyOwF)}
            >
              <LinkButton
