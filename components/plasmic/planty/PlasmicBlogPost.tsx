...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: iOUatfe-aEY2/css
...
function PlasmicBlogPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__sSbnV, {
          [sty.freeBoxlong__sSbnVpPWu]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__b8POn)}
              displayHeight={"auto"}
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__suyrN, {
          [sty.freeBoxlong__suyrNpPWu]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
