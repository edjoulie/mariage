...
import sty from "./PlasmicHeader3.module.css"; // plasmic-import: W_E4Ct7Kt6Of/css
...
function PlasmicHeader3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <LogoWhiteSvgIcon
        className={classNames(projectcss.all, sty.svg__bl8DG)}
        role={"img"}
      />
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vk35W)}
      >
        <PlasmicLink__
          className={classNames(
            projectcss.all,
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ghQtl)}
      >
        <IconLink
          ...
          icon={
            <React.Fragment>
              <IconIcon
                className={classNames(projectcss.all, sty.svg__jdIc)}
                role={"img"}
              />
