...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: SqS70_XW4gk5/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: lL9av5DbGwSy/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: dNTEd-fefPNO/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg__eCLoJ, {
            [sty.svgexpanded__eCLoJ3DrRh]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__vxg8V, {
            [sty.svgexpanded__vxg8V3DrRh]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
