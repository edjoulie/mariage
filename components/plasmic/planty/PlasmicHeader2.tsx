...
import sty from "./PlasmicHeader2.module.css"; // plasmic-import: hmaXZuvwR90s/css

import Logo4SvgIcon from "./icons/PlasmicIcon__Logo4Svg"; // plasmic-import: MG9UCzToJKZR/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: FmyaxZ42_-Qm/icon
...
function PlasmicHeader2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <PlasmicLink__
        className={classNames(projectcss.all, projectcss.a, sty.link__l9Ak5)}
        component={Link}
        href={`/`}
        platform={"nextjs"}
      >
        <Logo4SvgIcon
          className={classNames(projectcss.all, sty.svg__pnPYc)}
          role={"img"}
        />
      </PlasmicLink__>
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qezC)}
      >
        <PlasmicLink__
          className={classNames(
            projectcss.all,
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__b5Nx8)}
      >
        <IconLink
          ...
          icon={
            <React.Fragment>
              <IconIcon
                className={classNames(projectcss.all, sty.svg__k9C2B)}
                role={"img"}
              />
